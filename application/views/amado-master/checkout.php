                        ...
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="number" class="form-control" placeholder="prix estimatif" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <select class="w-100" id="country">
                                            <option value="usa">Categorie</option>
                                        </select>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <textarea name="comment" class="form-control w-100" id="comment" cols="30" rows="10" placeholder="Description..."></textarea>
                                    </div>
                                    <div class="col-12 mb-3">
